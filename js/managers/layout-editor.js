...
class LayoutEditor {
    ...
    buildCatalog() {
        ...
        // Sizes (w, h) match manifest footprint dimensions in tiles
        return {
            'Bàn Ghế': [
                ...
                { id: 'mtable', name: 'Bàn họp', icon: '<img src="assets/furniture/TABLE_FRONT/TABLE_FRONT.png" style="height:24px; image-rendering:pixelated;">', w: 3, h: 4 },
                { id: 'table_small', name: 'Bàn nhỏ', icon: '<img src="assets/furniture/SMALL_TABLE/SMALL_TABLE_FRONT.png" style="height:24px; image-rendering:pixelated;">', w: 2, h: 2 },
                ...
                { id: 'chair', name: 'Ghế gỗ', icon: '<img src="assets/furniture/WOODEN_CHAIR/WOODEN_CHAIR_FRONT.png" style="height:24px; image-rendering:pixelated;">', w: 1, h: 2 },
            ],
            'Sofa & Giường': [
                { id: 'sofa', name: 'Sofa', icon: '<img src="assets/furniture/SOFA/SOFA_FRONT.png" style="height:24px; image-rendering:pixelated;">', w: 2, h: 1 },
                { id: 'armchair', name: 'Ghế bành', icon: '<img src="assets/furniture/CUSHIONED_BENCH/CUSHIONED_BENCH.png" style="height:24px; image-rendering:pixelated;">', w: 1, h: 1 },
                { id: 'bench', name: 'Ghế băng', icon: '<img src="assets/furniture/WOODEN_BENCH/WOODEN_BENCH.png" style="height:24px; image-rendering:pixelated;">', w: 1, h: 1 },
                { id: 'bed_single', name: 'Giường đơn', icon: '🛏️', w: 2, h: 3 },
                { id: 'bed_double', name: 'Giường đôi', icon: '🛏️', w: 3, h: 3 },
                { id: 'rug', name: 'Thảm', icon: '🟦', w: 3, h: 2 },
                { id: 'pillow', name: 'Gối', icon: '💤', w: 1, h: 1 },
            ],
            'Tủ & Kệ': [
                ...
                { id: 'cabinet', name: 'Tủ', icon: '<img src="assets/furniture/DOUBLE_BOOKSHELF/DOUBLE_BOOKSHELF.png" style="height:24px; image-rendering:pixelated;">', w: 2, h: 1 },
                { id: 'shelf', name: 'Kệ treo', icon: '📦', w: 2, h: 1 },
                { id: 'boxes', name: 'Thùng hàng', icon: '<img src="assets/furniture/BIN/BIN.png" style="height:24px; image-rendering:pixelated;">', w: 1, h: 1 },
            ],
            'Thiết Bị': [
                { id: 'pc', name: 'Máy tính', icon: '<img src="assets/furniture/PC/PC_FRONT_OFF.png" style="height:24px; image-rendering:pixelated;">', w: 1, h: 2 },
                { id: 'whiteboard', name: 'Bảng trắng', icon: '<img src="assets/furniture/WHITEBOARD/WHITEBOARD.png" style="height:24px; image-rendering:pixelated;">', w: 2, h: 2 },
            ...
            'Trang Trí': [
                { id: 'plant', name: 'Cây cảnh', icon: '<img src="assets/furniture/PLANT/PLANT.png" style="height:24px; image-rendering:pixelated;">', w: 1, h: 2 },
                { id: 'large_plant', name: 'Cây lớn', icon: '<img src="assets/furniture/LARGE_PLANT/LARGE_PLANT.png" style="height:24px; image-rendering:pixelated;">', w: 2, h: 3 },
